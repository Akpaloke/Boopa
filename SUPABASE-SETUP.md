...
Apply all migrations in `supabase/migrations` before deploying, including `202609181430_profiles_consistency.sql`, `202609181500_signup_profile_trigger.sql`, `202609182300_requested_fixes.sql`, and `202609191330_auth_rls.sql`. The requested-fixes migration creates/configures the `avatars` bucket and its ownership policies and adds `communities.whatsapp_link`; the auth migration scopes profile insert/update/read policies to the authenticated user id.
